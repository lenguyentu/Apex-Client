  ...
  return (
    <div className="flex items-center justify-between">
      <div>
        ...
        <p className="text-gray-600">Quản lý và theo dõi ứng viên</p>
      </div>
      <div className="flex items-center gap-3">
        <input
          type="text"
          placeholder="Tìm kiếm ứng viên..."
          className="px-4 py-2.5 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-black focus:border-transparent"
        />
